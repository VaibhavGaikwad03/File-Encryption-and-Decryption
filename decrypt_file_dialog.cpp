...
void DecryptFileDialog::decrypt_file_slot()
{
    ...
    {
        string message = "File \"" + file_name_textbox->text().toStdString() + "\" already decrypted!";
        QMessageBox::critical(this, tr("Error"), tr(message.c_str()));
    }
    ...
    {
        string message = "Data from file \"" + file_name_textbox->text().toStdString() + "\" decrypted successfully.";
